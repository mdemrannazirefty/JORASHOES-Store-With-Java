...
public class WomenProduct1 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public WomenProduct1(){
		...
		img = new ImageIcon("Image/WomenProduct1.jpg");
		...
		l2 = new JLabel("Product Name: White Women");
