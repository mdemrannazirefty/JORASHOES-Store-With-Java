...
public class WomenProduct2 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public WomenProduct2(){
		...
		img = new ImageIcon("Image/WomenProduct2.jpg");
		...
		l2 = new JLabel("Product Name: Golden Women");
