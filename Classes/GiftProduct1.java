...
public class GiftProduct1 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public GiftProduct1(){
		...
		img = new ImageIcon("Image/GiftProduct1.jpg");
		...
		l2 = new JLabel("Product Name: White Gift");
