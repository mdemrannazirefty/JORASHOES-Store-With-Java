...
public class MenProduct3 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public MenProduct3(){
		...
		img = new ImageIcon("Image/MenProduct3.jpg");
		...
		l2 = new JLabel("Product Name: Gray Men");
