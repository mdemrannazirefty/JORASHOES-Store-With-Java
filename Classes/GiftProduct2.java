...
public class GiftProduct2 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public GiftProduct2(){
		...
		img = new ImageIcon("Image/GiftProduct2.jpg");
		...
		l2 = new JLabel("Product Name: Black Gift");
