...
public class ChildProduct1 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public ChildProduct1(){
		...
		img = new ImageIcon("Image/ChildProduct1.jpg");
		...
		l2 = new JLabel("Product Name: White Child");
