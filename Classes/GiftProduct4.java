...
public class GiftProduct4 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public GiftProduct4(){
		...
		img = new ImageIcon("Image/GiftProduct4.jpg");
		...
		l2 = new JLabel("Product Name: Premium Gift");
