...
public class GiftProduct3 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public GiftProduct3(){
		...
		img = new ImageIcon("Image/GiftProduct3.jpg");
		...
		l2 = new JLabel("Product Name: Gray Gift");
