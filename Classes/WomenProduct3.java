...
public class WomenProduct3 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public WomenProduct3(){
		...
		img = new ImageIcon("Image/WomenProduct3.jpg");
		...
		l2 = new JLabel("Product Name: Gray Women");
