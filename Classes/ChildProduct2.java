...
public class ChildProduct2 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public ChildProduct2(){
		...
		img = new ImageIcon("Image/ChildProduct2.jpg");
		...
		l2 = new JLabel("Product Name: Green Child");
		...
		//colour in combobox
		String quantity[] = { "White", "Black", "Green", "Gray", "Pink", "Golden"};
