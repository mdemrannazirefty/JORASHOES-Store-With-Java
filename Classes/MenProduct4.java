...
public class MenProduct4 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public MenProduct4(){
		...
		img = new ImageIcon("Image/MenProduct4.jpg");
		...
		l2 = new JLabel("Product Name: Brown Men");
