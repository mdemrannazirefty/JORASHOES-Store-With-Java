...
{ 
	...
	*/	
		...
		img = new ImageIcon("Image/Giftb.jpg");
		...
		//Item1 Image
        i1i = new JButton();
        i1i.setIcon(new ImageIcon("Image/WhiteGift.png"));
		...
		//Item2 Image
        i2i = new JButton();
        i2i.setIcon(new ImageIcon("Image/BlackGift.png"));
		...
		//Item3 Image
        i3i = new JButton();
        i3i.setIcon(new ImageIcon("Image/GrayGift.png"));
		...
		//Item4 Image
        i4i = new JButton();
        i4i.setIcon(new ImageIcon("Image/PremiumGift.png"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			GiftProduct1 frame = new GiftProduct1();
			this.setVisible(false);
			frame.setVisible(true);
		}
		else if (ae.getSource()==i2i)
		{
			GiftProduct2 frame = new GiftProduct2();
			this.setVisible(false);
			frame.setVisible(true);
		}
		else if (ae.getSource()==i3i)
		{
			GiftProduct3 frame = new GiftProduct3();
			this.setVisible(false);
			frame.setVisible(true);
		}
		else if (ae.getSource()==i4i)
		{
			GiftProduct4 frame = new GiftProduct4();
			this.setVisible(false);
			frame.setVisible(true);
		}
