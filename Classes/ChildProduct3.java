...
public class ChildProduct3 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public ChildProduct3(){
		...
		img = new ImageIcon("Image/ChildProduct3.jpg");
		...
		l2 = new JLabel("Product Name: Wht-Red Child");
