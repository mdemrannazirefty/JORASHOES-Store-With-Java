...
public class ChildProduct4 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public ChildProduct4(){
		...
		img = new ImageIcon("Image/ChildProduct4.jpg");
		...
		l2 = new JLabel("Product Name: Pink Child");
