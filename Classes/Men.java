...
{ 
    ...
    public Men(){
		...
		img = new ImageIcon("Image/Menb.jpg");
		...
		//Item1 Image
        i1i = new JButton();
        i1i.setIcon(new ImageIcon("Image/WhiteMen.png"));
		...
		//Item2 Image
        i2i = new JButton();
        i2i.setIcon(new ImageIcon("Image/BlackMen.png"));
		...
		//Item3 Image
        i3i = new JButton();
        i3i.setIcon(new ImageIcon("Image/GrayMen.png"));
		...
		//Item4 Image
        i4i = new JButton();
        i4i.setIcon(new ImageIcon("Image/BrownMen.png"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			MenProduct1 frame = new MenProduct1();
			this.setVisible(false);
			frame.setVisible(true);
		}
		else if (ae.getSource()==i2i)
		{
			MenProduct2 frame = new MenProduct2();
			this.setVisible(false);
			frame.setVisible(true);
		}
		else if (ae.getSource()==i3i)
		{
			MenProduct3 frame = new MenProduct3();
			this.setVisible(false);
			frame.setVisible(true);
		}
		else if (ae.getSource()==i4i)
		{
			MenProduct4 frame = new MenProduct4();
			this.setVisible(false);
			frame.setVisible(true);
		}
