...
public class WomenProduct4 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
	JLabel background,sl,l1,l2,l3,l4,l5,l6,l7;
    ...
    public WomenProduct4(){
		...
		img = new ImageIcon("Image/WomenProduct4.jpg");
		...
		l2 = new JLabel("Product Name: Mix Colour Women");
        l2.setBounds(600,20,300 ,80);
        l2.setForeground(Color.black);
        l2.setFont(new Font("Default", Font.BOLD, 18));
        p2.add(l2);
		
		//Add Code text
		l3 = new JLabel("Code: 22xd18mcw");
        l3.setBounds(600,60,300 , 50);
