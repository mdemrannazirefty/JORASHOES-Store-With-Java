...
public class Women extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public Women(){
		...
		img = new ImageIcon("Image/womenb.jpg");
		...
		//Item1 Image
        i1i = new JButton();
        i1i.setIcon(new ImageIcon("Image/WhiteWomen.png"));
		...
		//Item2 Image
        i2i = new JButton();
        i2i.setIcon(new ImageIcon("Image/GoldenWomen.png"));
		...
		//Item3 Image
        i3i = new JButton();
        i3i.setIcon(new ImageIcon("Image/GrayWomen.png"));
		...
		//Item4 Image
        i4i = new JButton();
        i4i.setIcon(new ImageIcon("Image/MixWomen.png"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			WomenProduct1 frame = new WomenProduct1();
			this.setVisible(false);
			frame.setVisible(true);
		}
		else if (ae.getSource()==i2i)
		{
			WomenProduct2 frame = new WomenProduct2();
			this.setVisible(false);
			frame.setVisible(true);
		}
		else if (ae.getSource()==i3i)
		{
			WomenProduct3 frame = new WomenProduct3();
			this.setVisible(false);
			frame.setVisible(true);
		}
		else if (ae.getSource()==i4i)
		{
			WomenProduct4 frame = new WomenProduct4();
			this.setVisible(false);
			frame.setVisible(true);
		}
