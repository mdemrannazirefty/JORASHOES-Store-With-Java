...
public class MenProduct2 extends JFrame implements ActionListener
{ 
    JFrame f1;
	JPanel p1,p2,p3;
    ...
    public MenProduct2(){
		...
		img = new ImageIcon("Image/MenProduct2.jpg");
		...
		l2 = new JLabel("Product Name: Black Men");
